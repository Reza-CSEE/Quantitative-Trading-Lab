...
# File save path
save_path = f"/Users/rezaghasemi/Downloads/Programming/Quantitative/{ticker}_MACD_Strategy.csv"
...
# 📌 **Backtrader Strategy: MACD Crossover**
class MACDStrategy(bt.Strategy):
    params = (("macd1", 12), ("macd2", 26), ("macdsignal", 9))  # MACD Parameters
    ...
    def next(self):
        if not self.position:
            if self.macd.macd[0] > self.macd.signal[0]:  # Buy when MACD crosses above signal line
            ...
            if self.macd.macd[0] < self.macd.signal[0]:  # Sell when MACD crosses below signal line
